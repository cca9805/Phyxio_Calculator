...
export const formulas = [
...

  {
    ...
    formula: '\\displaystyle y(x)=x\\tan\\theta - \\frac{g}{2 v_0^2 \\cos^2\\theta}\\,x^2',
...

  {
    ...
    formula: '\\displaystyle T=\\frac{2 v_0 \\sin\\theta}{g}',
...

  {
    ...
    formula: '\\displaystyle R=\\frac{v_0^{2}\\sin(2\\theta)}{g}',
...

  {
    ...
    formula: '\\displaystyle H=\\frac{v_{0y}^{2}}{2g}=\\frac{v_0^{2}\\sin^{2}\\theta}{2g}',
...

  {
    ...
    formula: '\\displaystyle t_{H}=\\frac{v_{0y}}{g}',
...

  {
    ...
    formula: '\\displaystyle v(t) = \\sqrt{ v_x(t)^2 + v_y(t)^2 }',
