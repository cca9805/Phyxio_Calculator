...
export const formulas = [
  {
    ...
    notes: ['El módulo |r_{AB}| es la distancia entre A y B.']
  },
  {
    id: 'f-mr-2',
  ...
  },
  {
    ...
    formula: 'v_{obj/suelo} = v_{obj/medio} + v_{medio/suelo}',
    ...
    examples: [{ title: 'Barco en río', description: 'v_{barco/suelo} = v_{barco/agua} + v_{agua/suelo}' }]
  },
  {
    id: 'f-mr-8',
    title: 'Proyección sobre una dirección',
    formula: 'v_{AB}·û = (v_A - v_B)·û',
  ...
  },
  {
    ...
    formula: 'r_{A0} + v_A·t = r_{B0} + v_B·t (resolver t)',
    ...
    notes: ['Si v_A = v_B y r_{A0} \\neq r_{B0} no hay intersección; en 2D/3D puede requerir proyectar componentes.']
  }
];
